...
def download(hash):
  ...
  if not os.path.isfile(filename):
    urlretrieve("http://47.91.229.84:8888/avatar/{}?size={}&default=retro".format(hash, IMAGE_SIZE), filename=filename)
  else:
    pass
...
def queryPackage(query):
  url = "http://47.91.229.84:8888/api?text={}&from=0&size={}&quality=1.95&popularity=3.3&maintenance=2.05".format(query, PACKAGE_NUM)
